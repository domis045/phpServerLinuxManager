<?php
   ...
   if($_POST['log_id'] !=''){$_SESSION['log_id'] = $_POST['log_id'];}
   //-----[Mysql]------//
...
<html >
   ...
   <body>
	...
	<a href='index.php'><button type='submit' id='button' class='float' align='center'>Atsijungti</button></a>
         <p><hr>
		<textarea rows="4" cols="50" readonly style="min-height:50px;height:65%;width:100%;"><?php serverLogs($_SESSION['log_id'], strtolower($_SESSION['kalba']));?></textarea><hr>
		<a href='edit.php'><button type='submit' id='button' class='float'>Atgal</button></a> <a href="main.php"><button type='submit' id='button' class='float'>Keisti žaidimą</button></a>
         </p>
         <br />
      </div>
   </body>
